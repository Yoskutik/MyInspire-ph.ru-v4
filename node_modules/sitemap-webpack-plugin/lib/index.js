                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sitemaps.forEach(function (sitemap, idx) {
                            compilation.emitAsset(sitemapFilename(_this.filename, "xml", idx), new RawSource(sitemap, false));
                        });
                        return [2 /*return*/, sitemaps];
                    case 2:
                        err_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        compressed = _a.sent();
                        compilation.emitAsset(sitemapFilename(this.filename, "xml.gz", idx), new RawSource(compressed, false));
                        return [3 /*break*/, 5];
                    case 4:
                        err_2 = _a.sent();
