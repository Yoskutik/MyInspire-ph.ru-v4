...
const Message: FC = () => (
    <div className={styles.info__message}>
        ...
        <p>
            Предоставляю услуги профессионального фотографа. Сотрудничаю с профессиональными визажистами. Помогаю с
            организацией съёмок и воплощением самых смелых идей. Снимаю портреты в различных стилях, провожу съёмки в
            стиле Love Story, занимаюсь проведением фотопрогулок.
        </p>
        <p>
