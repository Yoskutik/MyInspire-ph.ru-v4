...
const description = 'Атмосферные фото в Санкт-Петербурге от профессионального фотографа. Фотосессия от ' +
    '6000 ₽. Свадебные съёмки, студийные фотосессии и фотопроуглки.';
